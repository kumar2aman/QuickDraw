    ...
    <>
      ...
      <div className="min-h-screen bg-gradient-to-br from-primary-50 via-white to-accent-50">
        ...
        <section className="relative pt-20 pb-32 overflow-hidden">
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              ...
              <p className="text-xl md:text-2xl text-gray-600 mb-8 max-w-3xl mx-auto animate-slide-up">
                Create, collaborate, and bring your thoughts to life with our
                intuitive drawing canvas. Perfect for brainstorming,
                wireframing, and visual collaboration.
              </p>
          ...
          <div
            className="absolute top-40 right-20 w-16 h-16 bg-accent-200 rounded-full opacity-50 animate-float"
            style={{ animationDelay: "2s" }}
          ></div>
          <div
            className="absolute bottom-20 left-1/4 w-12 h-12 bg-green-200 rounded-full opacity-50 animate-float"
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-600 max-w-2xl mx-auto">
                Powerful features designed to make your creative process
        ...
        <section className="py-20 bg-gradient-to-r from-primary-600 to-accent-600">
          <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
            ...
            <p className="text-xl text-primary-100 mb-8">
              Join thousands of creators who are already using QuickDraw to
